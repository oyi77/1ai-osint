...
class TGStatSource:
    ...
    async def fetch_raw_leaks(self, queries: list[str] | None = None, max_channels: int = 10) -> list[RawLeak]:
    ...
    async def _api_request(self, client: httpx.AsyncClient, endpoint: str, params: dict | None = None) -> dict | None:
        params = params or {}
