...
class GomodSource:
    ...
    def __init__(self, max_per_query: int = 15, request_delay: float = 2.0, timeout: float = 15.0):
    ...
    async def _inspect_module(self, client: httpx.AsyncClient, module_path: str) -> list[RawLeak]:
