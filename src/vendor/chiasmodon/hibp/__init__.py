...
class HIBPTool(OSINTTool):
    ...
    def search(self, query: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            resp = requests.get(self.API_URL.format(query), headers=headers, params={"truncateResponse": "false"})
    ...
    def scan(self, query: str, **kwargs) -> Dict[str, Any]:
        return {"status": "error", "tool": self.name, "error": "Scan not supported for HIBP"}
