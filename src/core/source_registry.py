...
_REGISTRY: dict[str, SourceEntry] = {
    ...
    "devto": SourceEntry(RE),
    "steam": SourceEntry(RE),
    "chess": SourceEntry(RE),
    "letterboxd": SourceEntry(RE),
    "medium": SourceEntry(RE),
    "pastebin": SourceEntry(RE),
    "youtube": SourceEntry(RE),
    "fandom": SourceEntry(RE),
