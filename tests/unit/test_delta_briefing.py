...
def test_delta_new_evidence():
    prev = {
        "evidence": [{"identifier_value": "old@x.com"}],
        "briefing": {
            "subject": {"emails": ["old@x.com"], "known_handles": []},
            "breach_records": [],
        },
    }
    curr = {
        "evidence": [
            {"identifier_value": "old@x.com"},
            {"identifier_value": "new@y.com"},
        ],
        "briefing": {
            "subject": {"emails": ["old@x.com", "new@y.com"], "known_handles": ["h1"]},
            "breach_records": [{"a": 1}],
        },
    }
