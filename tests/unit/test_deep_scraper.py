...
async def test_scrape_profile_success():
    ...
    mock_text_locator.all_inner_texts.return_value = ["Hello", "World", "This is a test bio."]
    ...
    with patch("src.modules.deep_scan.deep_scraper.CloakScraper.get_page", return_value=MockCloakScraperCM()):
